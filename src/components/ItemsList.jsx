			...
			<main className=" h-[calc(100%-15%)] overflow-auto mb-[150px] ">
				<section className=" flex flex-col gap-3 p-5 ">
					{currentItem.map((i, index) => (
						<div
							key={index}
							className="  bg-green-50 h-[120px] max-h-[120px] grid grid-cols-[70%_30%] justify-between shadow-lg rounded-lg p-2 gap-1 ">
							...
							<div className=" justify-self-end w-[90px] grid place-content-center">
								<img
									src={i.img}
									alt=""
